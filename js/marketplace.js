...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // View Livestock button functionality
    document.querySelectorAll('.cattle-actions .btn').forEach(btn => {
        btn.addEventListener('click', function(e) {
            e.preventDefault();
            
            // Find the breed name from the card
            const card = this.closest('.cattle-card');
            const breedElement = card.querySelector('.cattle-breed');
            const breed = breedElement.textContent.trim().toLowerCase();
            
            // Map breed names to their corresponding detail pages
            const breedPages = {
                'brahman': 'cattle-details.html',
                'gyr': 'gyr-details.html',
                'nelore': 'nelore-details.html',
                'guzerá': 'guzera-details.html',
                'indubrasil': 'indubrasil-details.html',
                'santa gertrudis': 'santa-gertrudis-details.html',
                'simbrah': 'simbrah-details.html',
                'holstein': 'holstein-details.html'
            };
            
            // Redirect to the appropriate page
            const targetPage = breedPages[breed] || 'cattle-details.html';
