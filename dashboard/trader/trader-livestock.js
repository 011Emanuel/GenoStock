    ...
    this.attachShadow({mode: 'open'}).innerHTML = `
      ...
      <section>
        <div class="section-header">
          <h2>Mi Ganado</h2>
          <p>Gestiona tu inventario de ganado de manera eficiente</p>
        </div>
        ...
        <div class="livestock-stats-overview">
          <div class="stat-item">
            ...
            <div class="stat-label">Total de Cabezas</div>
          </div>
          <div class="stat-item">
          ...
          <div class="stat-item">
            ...
            <div class="stat-label">Razas Diferentes</div>
          </div>
        </div>
        ...
        <div class="livestock-grid">
            ...
            <div class="livestock-image-container">
              ...
              <div class="livestock-overlay">
                <div class="overlay-content">
                  ...
                  <div class="overlay-subtitle">Raza Pura</div>
                </div>
              </div>
            </div>
            <div class="livestock-info">
              <div class="livestock-header">
                <div>
                  ...
                  <p class="livestock-breed">Raza Pura</p>
                </div>
              ...
              <div class="livestock-details">
                <div class="detail-item">
                  <div class="detail-value">3 años</div>
                  <div class="detail-label">Edad</div>
                </div>
                <div class="detail-item">
                  <div class="detail-value">Macho</div>
            ...
            <div class="livestock-image-container">
              ...
              <div class="livestock-overlay">
                <div class="overlay-content">
                  ...
                  <div class="overlay-subtitle">Raza Cruzada</div>
                </div>
              </div>
            </div>
            <div class="livestock-info">
              <div class="livestock-header">
                <div>
                  ...
                  <p class="livestock-breed">Raza Cruzada</p>
                </div>
              ...
              <div class="livestock-details">
                <div class="detail-item">
                  <div class="detail-value">2 años</div>
                  <div class="detail-label">Edad</div>
                </div>
                <div class="detail-item">
                  <div class="detail-value">Hembra</div>
                  <div class="detail-label">Género</div>
                </div>
              </div>
          ...
          <div class="livestock-card">
            ...
            <div class="livestock-info">
              ...
              <div class="livestock-details">
                <div class="detail-item">
                  <div class="detail-value">4 años</div>
                  <div class="detail-label">Edad</div>
                </div>
                <div class="detail-item">
                  <div class="detail-value">Hembra</div>
          ...
          <div class="add-livestock-card">
            ...
            <div class="add-title">Agregar Nuevo Ganado</div>
            <div class="add-description">Registra una nueva cabeza de ganado en tu inventario</div>
          </div>
        </div>
      </section>
    `;
