          ...
          <div class="stat-card">
            <div class="stat-icon bg-primary">
              <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M7 6.8C5.2 4.8 3.8 3.2 4.8 2c2.6 1.6 4.2 4.2 6.2 5 2-.8 3.6-3.4 6.2-5 1 1.2-.4 2.8-2.2 4.8"/>
                <path d="M7 8.8C4.5 9.3 3.8 10.3 4.5 11.5c1.3.6 2.5-.2 2.7-1.4"/>
                <path d="M17 8.8C19.5 9.3 20.2 10.3 19.5 11.5c-1.3.6-2.5-.2-2.7-1.4"/>
                <path d="M7 6.8c0 3.5 1.5 7.7 2.4 9.7.6 1.3 1.3 2.5 2.6 2.5s2-1.2 2.6-2.5c.9-2 2.4-6.2 2.4-9.7"/>
                <path d="M9.8 16h4.4"/>
                <path d="M10.2 16v1c0 .6.4 1 1 1h1.6c.6 0 1-.4 1-1v-1"/>
                <path d="M10.5 19.5c1 .5 2 .5 3 0"/>
              </svg>
            </div>
          ...
          <div class="stat-card">
            <div class="stat-icon bg-info">
              <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor">
                <path d="M8.5 4C6.8 4 5.4 4.8 4.6 6 3.4 5.6 2.3 5.3 1.5 5.3.7 5.3 0 6 0 7.8c0 1.3.7 2.4 1.8 3 .1 1 .5 1.9 1.1 2.7C4.1 14.9 5.9 16 8 16s3.9-1.1 5.1-2.5c.6-.8 1-1.7 1.1-2.7 1.1-.6 1.8-1.7 1.8-3 0-1.8-.7-2.5-1.5-2.5-.8 0-1.9.3-3.1.7-.8-1.2-2.2-2-3.9-2zm0 1.8c1.3 0 2.4.5 3.2 1.3.2.2.6.2.8 0 .6-.4 1.2-.6 1.8-.6.5 0 .8.3.8.8 0 .5-.3.8-.8.8h-.4c-.4 0-.7.3-.7.7 0 1.6-.9 3-2.3 3.7-.7.4-1.5.5-2.3.5s-1.6-.1-2.3-.5C4.9 12 4 10.6 4 9c0-.4-.3-.7-.7-.7h-.4c-.5 0-.8-.3-.8-.8 0-.5.3-.8.8-.8.6 0 1.2.2 1.8.6.2.2.6.2.8 0C6.1 6.3 7.2 5.8 8.5 5.8z"/>
                <path d="M18.5 11c-1.1 0-2.1.4-2.8 1.1-.6-.4-1.3-.6-2-.6-1.2 0-2.2 1-2.2 2.2 0 1 .6 1.8 1.5 2.2.1.7.4 1.4.9 2C14.7 19 15.8 20 17.5 20s2.8-1 3.6-2.1c.5-.6.8-1.3.9-2 .9-.4 1.5-1.2 1.5-2.2 0-1.2-1-2.2-2.2-2.2-.7 0-1.4.2-2 .6-.7-.7-1.7-1.1-2.8-1.1zm0 1.3c.7 0 1.3.2 1.8.7.1.1.3.1.4 0 .3-.2.7-.3 1-.3.5 0 .8.3.8.8 0 .5-.3.8-.8.8-.2 0-.4.2-.4.4 0 .8-.5 1.6-1.2 2-.4.2-.9.3-1.4.3s-1-.1-1.4-.3c-.7-.4-1.2-1.2-1.2-2 0-.2-.2-.4-.4-.4-.3 0-.7.1-1 .3-.1.1-.3.1-.4 0-.5-.5-.1-.7.5-.7.4 0 .8.1 1 .3.1.1.3.1.4 0 .5-.5 1.1-.7 1.8-.7z"/>
                <path d="M19 1.5c-1.3 0-2.3.8-2.7 1.8-.4-1-1.4-1.8-2.7-1.8-1.6 0-2.8 1.3-2.8 2.9 0 2.3 3.5 4.9 5.5 6.6 2-1.7 5.5-4.3 5.5-6.6 0-1.6-1.2-2.9-2.8-2.9z"/>
              </svg>
            </div>
            <div class="stat-content">
        ...
        <div class="main-content-grid">
          ...
          <div class="quick-actions-card">
            <div class="quick-actions-header">
              <div class="quick-actions-icon" style="color: #ffffff;">
                <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor"><path d="M13 2L3 14h7v8l10-12h-7z"/></svg>
              </div>
                ...
                <button class="quick-action-btn" id="quickAddCattle">
                  <div class="quick-action-icon primary">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M6.5 6.8C4.8 4.8 3.5 3.2 4.5 2c2.4 1.6 4 4.2 5.8 5 1.5-.6 2.8-2.4 4.8-4"/>
                      <path d="M6.5 8.8C4.2 9.3 3.5 10.3 4.2 11.5c1.2.6 2.3-.2 2.5-1.4"/>
                      <path d="M16 9c1.8.4 2.5 1.2 2 2.2-.8.5-1.7.1-2.2-.6"/>
                      <path d="M6.5 6.8c0 3.5 1.4 7.7 2.2 9.7.5 1.3 1.2 2.5 2.4 2.5 1.2 0 1.8-1.2 2.4-2.5.8-2 2-5.5 2.2-8.5"/>
                      <path d="M9.2 16h3.8"/>
                      <path d="M9.6 16v1c0 .6.4 1 1 1h1.2c.6 0 1-.4 1-1v-1"/>
                      <path d="M10 19.5c.8.4 1.6.4 2.4 0"/>
                      <circle cx="19" cy="5" r="4" fill="currentColor" stroke="none" />
                      <path d="M19 3v4M17 5h4" stroke="var(--primary, #2c5530)" stroke-width="1.8"/>
                    </svg>
                  </div>
      ...
      <div class="modal-overlay" id="breedingModal">
        <div class="agenda-modal">
          <div class="modal-header" style="background: linear-gradient(135deg, #1b3a1d 0%, #2c5530 100%);">
            <h3>
              <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor" style="color:#ffa726;">
                <path d="M8.5 4C6.8 4 5.4 4.8 4.6 6 3.4 5.6 2.3 5.3 1.5 5.3.7 5.3 0 6 0 7.8c0 1.3.7 2.4 1.8 3 .1 1 .5 1.9 1.1 2.7C4.1 14.9 5.9 16 8 16s3.9-1.1 5.1-2.5c.6-.8 1-1.7 1.1-2.7 1.1-.6 1.8-1.7 1.8-3 0-1.8-.7-2.5-1.5-2.5-.8 0-1.9.3-3.1.7-.8-1.2-2.2-2-3.9-2zm0 1.8c1.3 0 2.4.5 3.2 1.3.2.2.6.2.8 0 .6-.4 1.2-.6 1.8-.6.5 0 .8.3.8.8 0 .5-.3.8-.8.8h-.4c-.4 0-.7.3-.7.7 0 1.6-.9 3-2.3 3.7-.7.4-1.5.5-2.3.5s-1.6-.1-2.3-.5C4.9 12 4 10.6 4 9c0-.4-.3-.7-.7-.7h-.4c-.5 0-.8-.3-.8-.8 0-.5.3-.8.8-.8.6 0 1.2.2 1.8.6.2.2.6.2.8 0C6.1 6.3 7.2 5.8 8.5 5.8z"/>
                <path d="M18.5 11c-1.1 0-2.1.4-2.8 1.1-.6-.4-1.3-.6-2-.6-1.2 0-2.2 1-2.2 2.2 0 1 .6 1.8 1.5 2.2.1.7.4 1.4.9 2C14.7 19 15.8 20 17.5 20s2.8-1 3.6-2.1c.5-.6.8-1.3.9-2 .9-.4 1.5-1.2 1.5-2.2 0-1.2-1-2.2-2.2-2.2-.7 0-1.4.2-2 .6-.7-.7-1.7-1.1-2.8-1.1zm0 1.3c.7 0 1.3.2 1.8.7.1.1.3.1.4 0 .3-.2.7-.3 1-.3.5 0 .8.3.8.8 0 .5-.3.8-.8.8-.2 0-.4.2-.4.4 0 .8-.5 1.6-1.2 2-.4.2-.9.3-1.4.3s-1-.1-1.4-.3c-.7-.4-1.2-1.2-1.2-2 0-.2-.2-.4-.4-.4-.3 0-.7.1-1 .3-.1.1-.3.1-.4 0-.5-.5-.1-.7.5-.7.4 0 .8.1 1 .3.1.1.3.1.4 0 .5-.5 1.1-.7 1.8-.7z"/>
                <path d="M19 1.5c-1.3 0-2.3.8-2.7 1.8-.4-1-1.4-1.8-2.7-1.8-1.6 0-2.8 1.3-2.8 2.9 0 2.3 3.5 4.9 5.5 6.6 2-1.7 5.5-4.3 5.5-6.6 0-1.6-1.2-2.9-2.8-2.9z"/>
              </svg>
